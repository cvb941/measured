...
class Measure<T : Units>(val amount: Double, val units: T) : Comparable<Measure<T>> {
     ...
     */
    operator fun plus(other: Measure<T>): Measure<T> = Measure((this `in` units) + (other `in` units), units)

    /**
     * Subtract a compatible quantity from this one
     */
    operator fun minus(other: Measure<T>): Measure<T> = Measure((this `in` units) - (other `in` units), units)
...
/** A * (1 / B)        */
operator fun <A : Units, B : Units> A.times(other: InverseUnits<B>): UnitsRatio<A, B> = this / other.unit
/** A * (1 / A^2)      */
operator fun <A : Units> A.times(other: InverseUnits<Square<A>>): Measure<InverseUnits<A>> = ratio / other.unit.first.ratio / other.unit.first
/** A * (B / A)        */
operator fun <A : Units, B : Units> A.times(other: UnitsRatio<B, A>): Measure<B> = ratio / other.denominator.ratio * other.numerator
/** (A / B) * B        */
@JvmName("times1")
operator fun <A : Units, B : Units> UnitsRatio<A, B>.times(other: B): Measure<A> = other.ratio / denominator.ratio * numerator
/** (A / (B * C)) * B  */
@JvmName("times2")
...
/** A / (A / B) == A * (B / A) */
operator fun <A : Units, B : Units> A.div(other: UnitsRatio<A, B>): Measure<B> = this * other.reciprocal

/** (A * B) / A */
@JvmName("div1")
operator fun <A : Units, B : Units> UnitsProduct<A, B>.div(other: A): Measure<B> = first.ratio / other.ratio * second
/** (A * B) / B */
@JvmName("div2")
operator fun <A : Units, B : Units> UnitsProduct<A, B>.div(other: B): Measure<A> = second.ratio / other.ratio * first
/** (A * A) / A */
@JvmName("div3")
operator fun <A : Units> UnitsProduct<A, A>.div(other: A): Measure<A> = first.ratio / other.ratio * second
/** (A * B) / (C * B) */
@JvmName("div1")
operator fun <A : Units, B : Units, C : Units> UnitsProduct<A, B>.div(other: UnitsProduct<C, B>): UnitsRatio<A, C> = first / other.first
/** (A * B) / (C * A) */
@JvmName("div2")
operator fun <A : Units, B : Units, C : Units> UnitsProduct<A, B>.div(other: UnitsProduct<C, A>): UnitsRatio<B, C> = second / other.first
/** (A * B) / (B * C) */
@JvmName("div3")
operator fun <A : Units, B : Units, C : Units> UnitsProduct<A, B>.div(other: UnitsProduct<B, C>): UnitsRatio<A, C> = first / other.second
/** (A * B) / (A * C) */
@JvmName("div4")
operator fun <A : Units, B : Units, C : Units> UnitsProduct<A, B>.div(other: UnitsProduct<A, C>): UnitsRatio<B, C> = second / other.second
/** (A * B) / (A * A) */
@JvmName("div5")
operator fun <A : Units, B : Units> UnitsProduct<A, B>.div(other: UnitsProduct<A, A>): UnitsRatio<B, A> = second / other.second
/** (A * B) / (A * B) */
@JvmName("div7")
operator fun <A : Units, B : Units> UnitsProduct<A, B>.div(other: UnitsProduct<A, B>): Double = ratio / other.ratio
/** (A * B) / (B * A) */
@JvmName("div6")
operator fun <A : Units, B : Units> UnitsProduct<A, B>.div(other: UnitsProduct<B, A>): Double = ratio / other.ratio
/** (A * B) / (B * B) */
@JvmName("div8")
...
@JvmName("div1")
operator fun <A : Units, B : Units> UnitsRatio<A, B>.div(other: UnitsRatio<A, B>): Double = this * other.reciprocal
@JvmName("div2")
...
@JvmName("times1")
operator fun <A : Units, B : Units> Measure<A>.times(other: Measure<B>): Measure<UnitsProduct<A, B>> = amount * other.amount * (units * other.units)
@JvmName("times2")
operator fun <A : Units, B : Units> Measure<A>.times(other: Measure<UnitsRatio<B, A>>): Measure<B> = amount * other.amount * (units * other.units)
@JvmName("times7")
...
@JvmName("times3")
operator fun <A : Units, B : Units> Measure<UnitsRatio<A, B>>.times(other: Measure<B>): Measure<A> = amount * other.amount * (units * other.units)
@JvmName("times4")
...
@JvmName("times9")
operator fun <A : Units> Measure<InverseUnits<Square<A>>>.times(other: Measure<A>): Measure<InverseUnits<A>> = other * this
@JvmName("times10")
operator fun <A : Units> Measure<InverseUnits<A>>.times(other: Measure<A>): Double = amount * other.amount * (units * other.units)
@JvmName("times11")
...
@JvmName("div16")
operator fun <A : Units> Measure<A>.div(other: Measure<A>): Double = amount / other.amount * (units.ratio / other.units.ratio)
@JvmName("div16")
operator fun <A : Units, B : Units> Measure<A>.div(other: Measure<B>): Measure<UnitsRatio<A, B>> = amount / other.amount * (units / other.units)
@JvmName("div1")
operator fun <A : Units, B : Units> Measure<UnitsProduct<A, B>>.div(other: Measure<A>): Measure<B> = amount / other.amount * (units / other.units)
@JvmName("div2")
operator fun <A : Units, B : Units> Measure<UnitsProduct<A, B>>.div(other: Measure<B>): Measure<A> = amount / other.amount * (units / other.units)
@JvmName("div3")
...
@JvmName("div15")
operator fun <A : Units, B : Units> Measure<A>.div(other: Measure<UnitsRatio<A, B>>): Measure<B> = amount / other.amount * (units / other.units)
...
@JvmName("times16")
operator fun <A : Units, B : Units> Measure<InverseUnits<A>>.times(other: B): Measure<UnitsRatio<B, A>> = amount * (units * other)
...
@JvmName("times1")
operator fun <A : Units, B : Units> Measure<A>.times(other: B): Measure<UnitsProduct<A, B>> = amount * (units * other)
@JvmName("times2")
operator fun <A : Units, B : Units> Measure<A>.times(other: UnitsRatio<B, A>): Measure<B> = amount * (units * other)
@JvmName("times7")
operator fun <A : Units, B : Units> Measure<A>.times(other: InverseUnits<B>): Measure<UnitsRatio<A, B>> = amount * (units * other)
@JvmName("times3")
operator fun <A : Units, B : Units> Measure<UnitsRatio<A, B>>.times(other: B): Measure<A> = amount * (units * other)
@JvmName("times4")
...
@JvmName("div16")
operator fun <A : Units, B : Units> Measure<A>.div(other: B): Measure<UnitsRatio<A, B>> = amount * (units / other)
@JvmName("div1")
operator fun <A : Units, B : Units> Measure<UnitsProduct<A, B>>.div(other: A): Measure<B> = amount * (units / other)
@JvmName("div2")
operator fun <A : Units, B : Units> Measure<UnitsProduct<A, B>>.div(other: B): Measure<A> = amount * (units / other)
@JvmName("div3")
...
@JvmName("div7")
operator fun <A : Units, B : Units> Measure<UnitsProduct<A, B>>.div(other: UnitsProduct<A, A>): Measure<UnitsRatio<B, A>> = amount * (units / other)
@JvmName("div8")
operator fun <A : Units, B : Units> Measure<UnitsProduct<A, B>>.div(other: UnitsProduct<B, B>): Measure<UnitsRatio<A, B>> = amount * (units / other)

@JvmName("div9")
operator fun <A : Units, B : Units> Measure<UnitsRatio<A, B>>.div(other: B): Measure<UnitsRatio<A, UnitsProduct<B, B>>> = amount * (units / other)
@JvmName("div10")
...
@JvmName("div11")
operator fun <A : Units, B : Units> Measure<UnitsRatio<A, B>>.div(other: UnitsRatio<A, Square<B>>): Measure<B> = amount * (units / other)
@JvmName("div12")
...
@JvmName("div15")
operator fun <A : Units, B : Units> Measure<A>.div(other: UnitsRatio<A, B>): Measure<B> = amount * (units / other)
...
@JvmName("divMeasure")
operator fun <T : Units> Number.div(measure: Measure<T>): Measure<InverseUnits<T>> = this.toDouble() / measure.amount * InverseUnits(measure.units)
@JvmName("divInvMeasure")
operator fun <T : Units> Number.div(measure: Measure<InverseUnits<T>>): Measure<T> = this * measure.units.unit / measure.amount
